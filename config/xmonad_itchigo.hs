...
-- Font and colors
--
myFont = "xft:DejaVu Sans Mono:size=16" -- :style=Bold"
myBGColor = "#333333"
myFGColor = "#FFFDB3"
myWhiteColor = "#FFFFFF"
myBlackColor = "2b2b2b"
...
-- http://xmonad.org/xmonad-docs/xmonad-contrib/XMonad-Util-EZConfig.html add/remove keys
        ...
        , ((mod4Mask                , xK_y),       spawn "gnome-terminal") -- %! Launch terminal
        , ((mod4Mask                , xK_g),       spawn $ XMonad.terminal defaultConfig) -- %! Launch terminal
        , ((mod4Mask                , xK_p),       spawn $ "dmenu_run -fn '" ++ myFont ++ "'") -- %! Launch terminal
        , ((mod4Mask                , xK_o),       spawn $ "dmenu_run ") -- %! Launch terminal
        , ((mod4Mask .|. shiftMask  , xK_Return),  windows W.swapMaster) -- %! Swap the focused window and the master window<F12>
        , ((mod4Mask .|. shiftMask  , xK_v ),      windows copyToAll)
        , ((mod4Mask .|. shiftMask  , xK_l),       spawn "slock")
        , ((mod4Mask                , xK_f),       spawn "firefox")
        , ((mod4Mask                , xK_d),       spawn "dmfirefox")
        , ((mod4Mask                , xK_i),       sendMessage ToggleStruts)
        , ((controlMask             , xK_Print),   spawn "cd ~/nobackup/screen_shots; sleep 0.2; scrot -s")
        , ((0                       , xK_Print),   spawn "cd ~/nobackup/screen_shots; scrot")
        , ((mod4Mask                , xK_s),       spawn "cd ~/nobackup/screen_shots; scrot")

        -- XF86AudioLowerVolume
        --, ((0                       , 0x1008ff11), spawn "amixer -q -c 0 set Master 2dB-")
        , ((0                       , 0x1008ff11), spawn "amixer -q -c 0 set Master 5%-")
        --, ((0                       , 0x1008ff11), spawn "amixer -q -D pulse set Master 5%-")

        -- XF86AudioRaiseVolume
        --, ((0                       , 0x1008ff13), spawn "amixer -q -c 0 set Master 2dB+")
        , ((0                       , 0x1008ff13), spawn "amixer -q -c 0 set Master 5%+")
        --, ((0                       , 0x1008ff13), spawn "amixer -q -D pulse set Master 5%+")
